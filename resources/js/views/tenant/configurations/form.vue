                ...
                <el-tabs v-model="activeName" type="border-card" class="rounded">
                    ...
                    <el-tab-pane class="mb-3" name="second">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-4">
                                <label class="control-label">
                                    Dias de anticipación para alertar que un producto está por vencer
                                    <el-tooltip class="item"
                                                content="dias de anticipación para alertar qye un producto con fecha de vencimento está por vencer"
                                                effect="dark" placement="top-start">
                                        <i class="ri-information-line"></i>
                                    </el-tooltip>
                                </label>
                                <div :class="{ 'has-danger': errors.days_anticipation_item_exp_date }" class="form-group">
                                    <el-input-number v-model="form.days_anticipation_item_exp_date" :min="1" :max="31"/>
                                    <el-button @click="submit" type="success" plain>Guardar</el-button>
                                    <small v-if="errors.days_anticipation_item_exp_date" class="invalid-feedback"
                                           v-text="errors.days_anticipation_item_exp_date[0]"></small>
                                </div>
                            </div>
                        </div>
                    </el-tab-pane>
    ...
    methods: {
        ...
        initForm() {
            ...
            this.form = {
                ...
                days_anticipation_item_exp_date: 1
            };
        },
