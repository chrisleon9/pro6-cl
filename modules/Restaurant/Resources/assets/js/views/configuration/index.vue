              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="row mt-4">
                    <div class="col-md-4">
                      ...
                      <label class="control-label">
                        Habilitar {{environment_1.original_name }}
                        <template  v-if="form.enabled_environment_1">
                          <el-tag type="warning" @click="environment_1.enabled_edit=true" style="cursor: pointer;">Editar
                  ...
                  <div class="col-md-4">
                    ...
                    <label class="control-label">
                      Habilitar {{ environment_2.original_name }}
                      <template  v-if="form.enabled_environment_2">
                        <el-tag type="warning" @click="environment_2.enabled_edit=true" style="cursor: pointer;">Editar
                          <el-tooltip class="item"
                                      content="Editar Nombre de Ambiente"
                                      effect="dark"
                                      placement="top-start">
                    ...
                    <div class="col-md-4">
                      ...
                      <label class="control-label">
                        Habilitar {{ environment_3.original_name }}
                        <template  v-if="form.enabled_environment_3">
                          <el-tag type="warning" @click="environment_3.enabled_edit=true" style="cursor: pointer;">Editar
                            <el-tooltip class="item"
                                        content="Editar Nombre de Ambiente"
                                        effect="dark"
                                        placement="top-start">
                    ...
                    <div class="col-md-4">
                      ...
                      <label class="control-label">
                        Habilitar {{ environment_4.original_name }}
                        <template  v-if="form.enabled_environment_4">
                          <el-tag type="warning" @click="environment_4.enabled_edit=true" style="cursor: pointer;">Editar
                            <el-tooltip class="item"
                                        content="Editar Nombre de Ambiente"
                                        effect="dark"
                                        placement="top-start">
