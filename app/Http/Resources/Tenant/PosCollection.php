...
class PosCollection extends ResourceCollection
{
    ...
    public function toArray($request)
    {
        return $this->collection->transform(function ($row, $key) {
            ...
            $date_expiration = $this->getDateExpiration($row);
            ...
            return [
                ...
                'date_of_due' => $date_expiration->format('Y-m-d')
            ];
        });
    }
    ...
    private function getDateExpiration($row){
        $date_expiration = Item::where('id','=',$row->id)->first();
        return $date_expiration->date_of_due;
    }
